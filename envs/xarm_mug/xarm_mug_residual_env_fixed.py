...
@configclass
class XArmMugResidualFixedEnvCfg(DirectRLEnvCfg):
    # env
    ...
    robot = ArticulationCfg(
        ...
        actuators={
            "xarm_shoulder": ImplicitActuatorCfg(
                joint_names_expr=["xarm_joint[1-4]"],
                effort_limit=87.0,
            ...
            "xarm_forearm": ImplicitActuatorCfg(
                joint_names_expr=["xarm_joint[5-7]"],
                effort_limit=12.0,
                velocity_limit=2.61,
                stiffness=80,
                damping=80,
            ...
            #     joint_names_expr=["xarm_finger_joint.*"],
            #     effort_limit=200.0,
            #     velocity_limit=0.2,
            #     stiffness=2e3,
            #     damping=1e2,
...
class XArmMugResidualFixedEnv(DirectRLEnv):
    ...
    cfg: XArmMugResidualFixedEnvCfg

    def __init__(self, cfg: XArmMugResidualFixedEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self.robot_dof_speed_scales[self._robot.find_joints("xarm_finger_joint1")[0]] = 0.1
        self.robot_dof_speed_scales[self._robot.find_joints("xarm_finger_joint2")[0]] = 0.1
        ...
        hand_pose = get_env_local_pose(
            ...
            UsdGeom.Xformable(stage.GetPrimAtPath("/World/envs/env_0/Robot/xarm_link7")),
            self.device,
        )
