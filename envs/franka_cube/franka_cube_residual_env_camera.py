...
@configclass
class FrankaCubeResidualCamEnvCfg(DirectRLEnvCfg):
    # env
...
class FrankaCubeResidualCamEnv(DirectRLEnv):
    ...
    cfg: FrankaCubeResidualCamEnvCfg

    def __init__(self, cfg: FrankaCubeResidualCamEnvCfg, render_mode: str | None = None, **kwargs):
