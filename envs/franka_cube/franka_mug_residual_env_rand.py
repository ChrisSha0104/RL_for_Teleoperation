...
@configclass
class FrankaMugResidualRandEnvCfg(DirectRLEnvCfg):
    # env
    ...
    cube = RigidObjectCfg(
            ...
            spawn=sim_utils.UsdFileCfg(
                usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mugs/SM_Mug_A2.usd", 
                scale=(0.8, 0.8, 0.8),
...
class FrankaMugResidualRandEnv(DirectRLEnv):
    ...
    cfg: FrankaMugResidualRandEnvCfg

    def __init__(self, cfg: FrankaMugResidualRandEnvCfg, render_mode: str | None = None, **kwargs):
